...
const Divider = dynamic(() => import("@packages/ui/divider/index"), {
  ssr: false,
});
const FAB = dynamic(() => import("@packages/ui/fab/index"), {
  ssr: false,
});
const Icon = dynamic(() => import("@packages/ui/icon/index"), { ssr: false });
...
const ListItem = dynamic(
  () => import("@packages/ui/list/index").then((mod) => mod.ListItem),
  { ssr: false }
);
