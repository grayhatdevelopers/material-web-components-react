...
const IconButton = (props: any) => {
  if (matchVariant(props.variant, "md-filled-icon-button", "icon-button"))
    return <FilledIconButton {...props}>{props.children}</FilledIconButton>;
  if (matchVariant(props.variant, "md-filled-tonal-icon-button", "icon-button"))
    return (
      <FilledTonalIconButton {...props}>{props.children}</FilledTonalIconButton>
    );
  if (matchVariant(props.variant, "md-outlined-icon-button", "icon-button"))
    return <OutlinedIconButton {...props}>{props.children}</OutlinedIconButton>;
