...
export type { MdTabs } from "@material/web/tabs/tabs";

export type { MdPrimaryTab } from "@material/web/tabs/primary-tab";

export type { MdSecondaryTab } from "@material/web/tabs/secondary-tab";
