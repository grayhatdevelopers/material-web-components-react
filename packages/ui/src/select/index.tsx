...
export type { MdFilledSelect } from "@material/web/select/filled-select";

export type { MdOutlinedSelect } from "@material/web/select/outlined-select";
export type { MdSelectOption } from "@material/web/select/select-option";
...
const Select = (props: any) => {
  if (matchVariant(props.variant, "md-filled-select"))
    return <FilledSelect {...props}>{props.children}</FilledSelect>;
