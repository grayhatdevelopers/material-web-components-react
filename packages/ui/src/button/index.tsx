...
const Button = (props: any) => {
  if (matchVariant(props.variant, "md-filled-button"))
    return <FilledButton {...props}>{props.children}</FilledButton>;
  if (matchVariant(props.variant, "md-filled-tonal-button"))
    return <FilledTonalButton {...props}>{props.children}</FilledTonalButton>;
  if (matchVariant(props.variant, "md-outlined-button"))
    return <OutlinedButton {...props}>{props.children}</OutlinedButton>;
  if (matchVariant(props.variant, "md-text-button"))
